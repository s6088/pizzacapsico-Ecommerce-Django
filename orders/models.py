...
from pizzacapsico.utils import unique_order_id_generator
...
class Order(models.Model):
    ...
    location = models.CharField(max_length=200, default='https://www.google.com/maps/?q=50.830521,4.385652')
    ...
    def check_done(self):
        ...
        total = self.total
        if billing_profile and shipping_done:
            #if total > 0:
            return True
        return False

    def update_purchases(self):
        entries = Entry.objects.get_cart(self.cart)
        for e in entries:
            if e.quantity > 0:
                p = e.product
...
def pre_save_create_order_id(sender, instance, *args, **kwargs):
    ...
    if instance.shipping_address and not instance.shipping_address_final:
        ...
        lat = instance.shipping_address.latitude
        lng = instance.shipping_address.longitude
        instance.location = 'http://maps.google.com/maps?q=' + lat + ',' + lng
