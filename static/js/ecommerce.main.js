$(document).ready(function(){
  ...
  form.on('submit', function(event) {
    ...
    var loadingHtml = "<i class='fa fa-spin fa-spinner'></i> Processing..."
    var loadingClasses = "btn btn-white btn-outline-white disabled my-3"
  ...
  function stripeTokenHandler(nextUrl, token){
      ...
      $.ajax({
          ...
          success: function(data){
              var succesMsg = data.message || "Success! Your card has added."
              card.clear()
              if (nextUrl){
